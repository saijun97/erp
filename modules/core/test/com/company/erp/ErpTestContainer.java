...
public class ErpTestContainer extends TestContainer {

    public ErpTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/erp/app.properties",
    ...
    public static class Common extends ErpTestContainer {

        public static final ErpTestContainer.Common INSTANCE = new ErpTestContainer.Common();
