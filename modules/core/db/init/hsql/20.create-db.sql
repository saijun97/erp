...
create unique index IDX_ERP_CONTACT_PERSON_UNIQ_EMAIL on ERP_CONTACT_PERSON (EMAIL) ^
create unique index IDX_ERP_CONTACT_PERSON_UNIQ_MOBILE_PHONE on ERP_CONTACT_PERSON (MOBILE_PHONE) ^
